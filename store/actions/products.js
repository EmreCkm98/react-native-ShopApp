  ...
  return async (dispatch, getState) => {
    ...
    try {
      const response = await fetch(
        "https://rn-shoppingapp-8b23a-default-rtdb.europe-west1.firebasedatabase.app/products.json"
      );
...
export const deleteProduct = (productId) => {
  return async (dispatch, getState) => {
    ...
    const response = await fetch(
      `https://rn-shoppingapp-8b23a-default-rtdb.europe-west1.firebasedatabase.app/products/${productId}.json?auth=${token}`,
      {
        method: "DELETE",
      }
    );
